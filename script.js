function calculateEarnings() {
    ...
    document.getElementById('total-earnings').innerText = `${earnings.toFixed(2)} zł`;
    document.getElementById('debt-payment').innerText = `${repayment.toFixed(2)} zł`;
    document.getElementById('remaining-debt').innerText = `${remainingDebt.toFixed(2)} zł`;
    document.getElementById('final-earnings').innerText = `${finalEarnings.toFixed(2)} zł`;
